...
public class QNews extends EntityPathBase<News> {
    ...
    private static final long serialVersionUID = -389497614L;
    ...
    public final EnumPath<kr.kickon.api.global.common.enums.NewsCategory> category = createEnum("category", kr.kickon.api.global.common.enums.NewsCategory.class);
